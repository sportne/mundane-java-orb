...
- `G12-100-DURABLE-ORB-POA-IDENTITY-DESIGN-GATE` is the next non-human-gated roadmap task
...
`docs/roadmap/tasks/g12-040-idl-to-java-mapping-hardening.md` is the next
