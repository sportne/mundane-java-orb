...
public final class NativeImageTargets {
  ...
  private static final NativeImageTarget NOTIFICATION_SERVICE =
      target(
          "notificationService",
  ...
  private static final NativeImageTarget TRANSACTION_SERVICE =
      target(
          "transactionService",
          "TransactionServiceNativeSmoke",
          "transaction-service-native-smoke");
