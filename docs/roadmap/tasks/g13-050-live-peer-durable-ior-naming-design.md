...
ADR IDs: ADR-0001, ADR-0003, ADR-0005, ADR-0006, ADR-0007, ADR-0008, ADR-0010, ADR-0014
...
Expected behavior: Task type: design-only. Blocked until G13-040 completes. Define future live peer durable persistence scenarios only as opaque object-key preservation claims, not peer understanding of the project-owned `MJOK` or `MJNS` formats; do not approve live execution.
