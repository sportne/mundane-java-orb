...
Allowed files: modules/corba-native-image/build.gradle, modules/corba-native-image/README.md, modules/corba-native-image/src/**, build-logic/**, docs/verification/native-image-matrix.md, docs/architecture/native-image-design.md, README.md, docs/roadmap/roadmap-index.md, docs/roadmap/tasks/g6-910-native-image-binaries.md, docs/roadmap/tasks/g6-920-offline-release-validation.md
...
Commands to run: ./gradlew :modules:corba-native-image:test; ./gradlew :modules:corba-native-image:nativeImageBinariesSmoke; ./gradlew validateDesignControlPack qualityGate; git diff --check
