...
Expected behavior: Task type: human-gate-blocked. After G14-020 and G14-030 complete, maintainers may approve live durable peer execution. The approved claim is limited to peer clients preserving opaque object-key bytes when invoking our restarted servers or resolving our persistent Naming references after restart.
