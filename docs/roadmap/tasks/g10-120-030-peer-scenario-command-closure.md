...
Forbidden files: production library behavior changes, Gradle build logic changes, vendored peer source, committed peer binaries, committed TAO-generated C++ sources, optional service implementation, unapproved release version changes
