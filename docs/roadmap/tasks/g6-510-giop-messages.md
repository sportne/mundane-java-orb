...
Allowed files: README.md, docs/roadmap/roadmap-index.md, docs/roadmap/tasks/g6-510-giop-messages.md, docs/roadmap/tasks/g6-520-iiop-tcp.md, docs/architecture/cdr-giop-iiop.md, docs/conformance/**, modules/corba-giop/build.gradle, modules/corba-giop/README.md, modules/corba-giop/src/**, modules/corba-cdr/src/main/**, modules/corba-cdr/src/test/**
...
Commands to run: ./gradlew :modules:corba-cdr:test :modules:corba-giop:test; ./gradlew validateDesignControlPack qualityGate; git diff --check
