...
Allowed files: modules/corba-notification-service/src/**, modules/corba-notification-service/README.md, modules/corba-native-image/src/**, modules/corba-native-image/build.gradle, docs/architecture/services-design.md, docs/conformance/optional-services-matrix.md, docs/verification/optional-services-review.md, docs/verification/native-image-matrix.md, docs/roadmap/roadmap-index.md, docs/roadmap/tasks/g8-370-notification-service-native-smoke.md, docs/roadmap/tasks/g8-380-notification-service-interop-metadata.md, README.md
...
Completion evidence: Added `NotificationServiceNativeSmoke`, aggregate Native Image target wiring, JVM parity entrypoint tests, and source-level Native Image metadata audit coverage for Notification Service production sources. Documentation records no reflection, dynamic-proxy, serialization, service-loader, bytecode-generation, internal-JDK, `Unsafe`, metadata-file, live peer, or pass/fail interop claim.
