...
Expected behavior: Task type: implementation. Human-gate-blocked until G13-080 completes and maintainers approve continuation. Route opaque persistent IIOP object keys into ORB/POA durable rehydration lookup without making protocol modules parse `MJOK`.
