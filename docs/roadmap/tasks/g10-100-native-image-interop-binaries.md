...
Acceptance criteria: This task remains blocked until G10-080 and G10-090 are complete; native client/server binaries exist for all G10 interop lanes when Native Image is available; unavailable toolchains produce structured infrastructure reports rather than silent omissions.
