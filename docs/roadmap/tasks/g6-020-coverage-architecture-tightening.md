...
Allowed files: build-logic/src/main/groovy/corba.coverage-conventions.gradle, modules/corba-architecture-tests/src/test/java/**, docs/verification/coverage-policy.md, docs/architecture/module-boundaries.md
