...
Expected behavior: Task type: implementation. Human-gate-blocked until G13-070 completes and maintainers approve continuation. Apply POA servant-manager policy to validated durable object ids after durable POA path lookup.
