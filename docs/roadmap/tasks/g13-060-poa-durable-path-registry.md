...
Expected behavior: Task type: implementation. Human-gate-blocked until maintainer approval after G13-050. Add an explicit durable POA path registry for caller-approved persistent POA paths without adding adapter activation or servant rehydration behavior.
