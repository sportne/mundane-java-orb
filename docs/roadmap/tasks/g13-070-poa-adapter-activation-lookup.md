...
Expected behavior: Task type: implementation. Human-gate-blocked until G13-060 completes and maintainers approve continuation. Route valid durable POA paths through explicit adapter activation lookup when the addressed persistent POA is not active.
