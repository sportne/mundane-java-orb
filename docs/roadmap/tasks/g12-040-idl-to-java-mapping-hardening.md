...
Allowed files: modules/corba-idl-java-mapping/src/**, modules/corba-codegen/src/**, modules/corba-typecode/src/**, modules/corba-dynamic/src/**, modules/corba-testkit/src/**, docs/architecture/idl-compiler-architecture.md, docs/conformance/idl-to-java-matrix.md, docs/conformance/idl-4.2-matrix.md, docs/roadmap/roadmap-index.md, docs/roadmap/tasks/g12-040-idl-to-java-mapping-hardening.md, docs/roadmap/tasks/g12-050-wide-idl-feature-interop-corpus.md, README.md
...
Commands to run: ./gradlew :modules:corba-idl-java-mapping:test :modules:corba-codegen:test :modules:corba-typecode:test :modules:corba-dynamic:test; ./gradlew validateDesignControlPack qualityGate; git diff --check
...
Completion evidence: G12-040 adds compile-safe legacy and modern mappings for
native declarations, value boxes, and full valuetypes; preserves repository IDs,
valuetype base/support metadata, helper, holder, stub, POA-placeholder,
descriptor, codec-surface, and TypeCode metadata output for the richer G12 corpus;
rejects custom valuetype, deferred wire TypeCode, and deferred DynamicAny mappings
explicitly; compiles generated source without reflection, runtime bytecode
generation, Java serialization, or `org.omg.*`; and hands off roadmap readiness to
G12-050.
