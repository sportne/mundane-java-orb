...
Allowed files: modules/corba-naming-server/src/**, docs/architecture/services-design.md, docs/conformance/naming-service-matrix.md, docs/roadmap/roadmap-index.md, docs/roadmap/tasks/g13-030-mjns-store-versioning-policy.md, docs/roadmap/tasks/g13-040-durable-poa-rehydration-design-gate.md, README.md
