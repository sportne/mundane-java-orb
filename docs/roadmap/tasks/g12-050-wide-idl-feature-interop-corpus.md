...
Completion evidence: G12-050 adds source-controlled broad IDL corpus fixtures for
core constructed types, repository pragmas, native declarations, value boxes,
valuetype inheritance, supported interfaces, factories, and intentionally
unsupported custom valuetypes. Local codegen tests parse, analyze, map, generate
descriptor/source surfaces, and compile the supported fixtures. The interop
testkit records G12 scenario IDs and validates deterministic local JVM structured
reports. Native Image tests cover G12 fixture validation and structured
missing-prerequisite reports for selected Native Image lanes. G12-060 is promoted
for live peer scenario selection.
