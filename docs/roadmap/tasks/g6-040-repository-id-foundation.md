...
Specification references: CORBA-IOP-IOR, CORBA-IF-OBJECT-REF, IDL-42-SCOPING
Target module: modules/corba-repository-id
Allowed files: modules/corba-repository-id/src/main/**, modules/corba-repository-id/src/test/**, modules/corba-repository-id/README.md, docs/conformance/**
