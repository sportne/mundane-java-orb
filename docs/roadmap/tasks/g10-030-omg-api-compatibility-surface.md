...
Allowed files: modules/corba-omg-api/src/**, modules/corba-omg-api/README.md, modules/corba-architecture-tests/src/**, config/spotbugs/exclude.xml, docs/architecture/module-boundaries.md, docs/conformance/corba-2.3-legacy-java-matrix.md, docs/conformance/corba-3.4-matrix.md, docs/conformance/naming-service-matrix.md, docs/verification/native-image-matrix.md, docs/roadmap/roadmap-index.md, docs/roadmap/tasks/g10-030-omg-api-compatibility-surface.md, docs/roadmap/tasks/g10-040-cdr-giop-ior-wire-closure.md, README.md
