...
- `tasks/g8-140-time-service-conformance-closure.md` - complete
- `tasks/g8-200-event-service-task-group.md` - complete
...
- `tasks/g8-250-event-service-native-smoke.md` - complete
...
- `tasks/g8-320-notification-service-structured-event-model.md` - complete
- `tasks/g8-330-notification-service-bounded-filter-model.md` - complete
- `tasks/g8-340-notification-service-qos-admin-policy-validation.md` - complete
...
- `tasks/g8-390-notification-service-conformance-closure.md` - complete
...
- `tasks/g8-440-trading-service-local-query.md` - complete
- `tasks/g8-450-trading-service-import-export-boundary.md` - complete
...
- `tasks/g8-510-transaction-service-coordinator-resource-model.md` - complete
- `tasks/g8-520-transaction-service-timeout-policy.md` - complete
...
- `tasks/g8-570-transaction-service-native-smoke.md` - complete
- `tasks/g8-580-transaction-service-interop-metadata.md` - complete
...
- `tasks/g8-630-security-service-csiv2-metadata-model.md` - complete
...
- `tasks/g8-680-security-service-interop-metadata.md` - complete
- `tasks/g8-690-security-service-conformance-closure.md` - ready-for-implementation
