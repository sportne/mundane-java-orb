...
|---|---|---|---|---|---|
| Time Service | TIME-11 | REQ-SVC-060, REQ-SVC-001 | live-approved | G8-100/G8-110 unit and Native Image smoke; G8-120 harness dry-run tests | G8-100 implements TimeBase-compatible UTC and interval values, caller-configured local clock policy, universal-time query behavior, and bounded diagnostics. G8-110 implements descriptor-backed loopback IIOP, TimeBase field codecs, and optional Naming registration. G8-120 adds approved-peer scenario metadata and missing-prerequisite reports. G8-130 records maintainer approval for live peer execution; G8-140 must still run and summarize the approved matrix before live compatibility is claimed. |
