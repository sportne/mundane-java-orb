...
|---|---|---|---|---|---|
| Time Service | TIME-11 | REQ-SVC-060, REQ-SVC-001 | local-subset | G8-100 unit and Native Image smoke | G8-100 implements TimeBase-compatible UTC and interval values, caller-configured local clock policy, universal-time query behavior, and bounded diagnostics. IIOP/Naming exposure, interop metadata, live peer execution, and closure remain staged. |
