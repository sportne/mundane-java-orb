...
|---|---|---|---|---|---|
| Time Service | TIME-11 | REQ-SVC-060, REQ-SVC-001 | local-iiop-subset | G8-100/G8-110 unit and Native Image smoke | G8-100 implements TimeBase-compatible UTC and interval values, caller-configured local clock policy, universal-time query behavior, and bounded diagnostics. G8-110 implements descriptor-backed loopback IIOP, TimeBase field codecs, and optional Naming registration. Interop metadata, live peer execution, and closure remain staged. |
