...
| GIOP | CORBA 3.2 Interoperability sections 9.2 through 9.6 | REQ-GIOP-001 | partial | `GiopMessageCodecTest` | G6-510 starts bounded GIOP 1.2 message syntax read/write behavior. G10-040 adds ProfileAddr/ReferenceAddr target forms, exception bodies, code-set contexts, and bounded fragment assembly. ORB dispatch, POA lookup, and peer interop remain future work. |
