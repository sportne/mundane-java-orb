...
| IIOP | CORBA 3.2 Interoperability section 9.7, Internet Inter-ORB Protocol | REQ-IIOP-001 | partial | `IiopTcpTest` | G6-520 starts local loopback TCP transport for bounded GIOP request/reply frames. TLS/mTLS, pooling, ORB dispatch, POA lookup, and peer interop remain future work. |
