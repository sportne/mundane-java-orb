...
| Java-to-IDL and RMI-IIOP adapters | JAV2I-14, JAV2I-14-RMI-IDL | REQ-RMI-001 | deferred | unassigned | ADR-0013 is proposed as the design gate. Future work must define Java eligibility, generated IDL fixtures, repository ID behavior, adapter invocation, interop, and Native Image evidence before implementation begins. |
