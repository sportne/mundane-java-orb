...
| Java-to-IDL and RMI-IIOP adapters | JAV2I-14, JAV2I-14-RMI-IDL | REQ-RMI-001 | partial | `RmiJavaEligibilityCheckerTest` | G7-010 adds explicit Java remote-interface eligibility diagnostics for the first Java-to-IDL input slice. Java-to-IDL mapping, generated IDL fixtures, repository ID behavior, adapter invocation, interop, and Native Image evidence remain deferred to later G7 tasks. |
