...
| Java-to-IDL and RMI-IIOP adapters | JAV2I-14, JAV2I-14-RMI-IDL | REQ-RMI-001 | designed | unassigned | ADR-0013 accepted the design gate. G7 tasks define Java eligibility, generated IDL fixtures, repository ID behavior, adapter invocation, interop, and Native Image evidence before implementation claims are recorded. |
