...
| RMI-IIOP and Java-to-IDL | JAV2I-14-RMI-IDL | REQ-RMI-001 | deferred | unassigned | ADR-0013 is proposed as the design gate. No RMI-IIOP runtime behavior, Java-to-IDL generation, stub/tie/skeleton implementation, value marshaling, or peer compatibility claim is approved until maintainers accept the gate and promote follow-on roadmap tasks. |
