...
| RMI-IIOP and Java-to-IDL | JAV2I-14-RMI-IDL | REQ-RMI-001 | partial | `RmiJavaEligibilityCheckerTest`, `RmiJavaToIdlMapperTest`, `RepositoryIdTest`, `RmiRepositoryIdPlannerTest` | ADR-0013 accepted the design gate. G7-010 adds explicit Java remote-interface eligibility diagnostics, G7-020 adds in-memory Java-to-IDL models, and G7-030 adds explicit metadata-based RMI repository ID validation and planning. Generated IDL, stub/tie/skeleton implementation, value marshaling, runtime adapters, wire behavior, and peer compatibility claims remain deferred. |
