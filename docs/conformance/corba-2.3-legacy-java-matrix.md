...
| RMI-IIOP and Java-to-IDL | JAV2I-14-RMI-IDL | REQ-RMI-001 | designed | unassigned | ADR-0013 accepted the design gate. G7 tasks stage RMI-IIOP runtime behavior, Java-to-IDL generation, stub/tie/skeleton implementation, value marshaling, and peer compatibility claims before implementation evidence is recorded. |
