...
Service has started with bounded type and offer repositories plus constraint
evaluation, and local query is the only ready Trading slice; Transaction and
