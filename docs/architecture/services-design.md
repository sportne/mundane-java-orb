...
Event Service compatibility boundary, the G8-320 structured-event model, and
the G8-330 bounded filter evaluator; QoS/admin policy validation is the next
