...
Event Service compatibility boundary; structured-event modeling is the next
ready slice. Trading, Transaction, and Security/CSIv2 remain blocked behind
their task groups.
