...
|---|---|---|---|---|
| REQ-SVC-010 | Stage Trading Service behind approved ADR-0020 and blocked G8-400 task slices. | design-approved | corba-trading-service, corba-services-core | TRADE-10 |
...
| REQ-SVC-050 | Stage Security Service / CSIv2 behind approved ADR-0022 and blocked G8-600 task slices. | design-approved | corba-security-service, corba-services-core | SEC-18, CORBA-IOP-SECURITY |
