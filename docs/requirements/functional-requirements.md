...
| REQ-RMI-001 | Implement RMI-IIOP and Java-to-IDL only after dedicated compatibility design approval. | draft | corba-rmi-iiop | JAV2I-14-RMI-IDL; implementation deferred pending ADR |
