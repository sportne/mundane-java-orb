...
| REQ-BUILD-006 | Use JUnit Platform/Jupiter. | draft |
| REQ-BUILD-007 | Use ArchUnit for architecture enforcement. | draft |
| REQ-BUILD-008 | Use JaCoCo coverage reporting and verification. | draft |
| REQ-BUILD-009 | Use Spotless, Checkstyle, SpotBugs, and Error Prone. | draft |
| REQ-BUILD-010 | Publish independent artifacts plus a BOM. | draft |
